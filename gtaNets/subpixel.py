...
class Subpixel(Conv2D):
    def __init__(self,
        ...
        super(Subpixel, self).__init__(
            ...
            bias_regularizer=bias_regularizer, # None
            activity_regularizer=activity_regularizer, # None
            kernel_constraint=kernel_constraint, # None
            bias_constraint=bias_constraint, # None
            **kwargs)
        self.r = r
...
if __name__ == "__main__":
	...
	model.fit(padded, HDimages, epochs=50, validation_split=.2)
