...
class Perceptual_Teacher_N(object):
    def __init__(self, width, height, channels, imagenet=False):
        ...
        #t = model.output
        #t = model.get_layer('normal_concat_18').output
        # yang
        ...
        self.interm = Model(inputs=self.base_model.input,
                        outputs=self.base_model.get_layer('normal_concat_18').output)
